...
public class LlamadaUsuarioWS {
	...
	/** URL donde se encuentra el servicio web */
	 ...
	 "http://192.168.1.36:8090/axis2/services/UsuarioWebService?wsdl";
	 ...
	 * usuario y la contraseña coinciden
	 * 
	 * @param usuario
	 *            Id del usuario
	 * @param contraseña
	...
	/**
	 * Método que dice si un usuario existe o no Si el usuario existe devuelve
