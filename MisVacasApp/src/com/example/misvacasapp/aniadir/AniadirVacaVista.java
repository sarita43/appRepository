...
/**
 * Clase de la actividad de añadir vaca. En ella se implementan los métodos que se
 * utilizan para manejar la vista de añadir vaca
 * 
...
public class AniadirVacaVista extends ActionBarActivity {
	...
	/**
	 * Añade la vista de añadir vaca. Recoge el usuario de la vista del usuario. Inicializa parametros
	 * */
	@Override
	 ...
	 * En el se llama a las comprobaciones que se pueden hacer para añadir el animal correctamente y añade el animal si todo es correcto
	 * @param view Vista
	 * */
