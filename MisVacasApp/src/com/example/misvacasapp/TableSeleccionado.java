...
/**
 * Clase que crea una tabla hash para saber que elementos han sido seleccionados en la lista
...
//	private static TableSeleccionado _uniqueInstance;
	...
	/** 
	 * Constructor
	 * Crea una nueva tabla hash vacia que introduce en el primer valor un entero (el indice en la lista) y el segundo valor un boolean, 
	 * si esta seleccionado en la vista de la lista se pone un true y si no un false. Al principio todos los valores de la lsta serán false.
	 * */
