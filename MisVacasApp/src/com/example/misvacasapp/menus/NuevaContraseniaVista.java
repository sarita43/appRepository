...
/**
 * Clase de la actividad cambiar contraseña <p>En ella se implementan los métodos que se
 * utilizan para manejar la vista de cambiar contraseña</p>
 * 
...
public class NuevaContraseniaVista extends ActionBarActivity {
	...
	//Métodos
	/**
	 * Añade la vista de cambiar contraseña
	...
	//PORQUE LLAMO AL WEB SERVICE SI SE PUEDE COMPROBAR LA CONTRASEÑA CON LA QUE E PASADO DE ANTES DE LA VISTA ANTERIOR
	/**
	 * Método que se ejecuta cuando se da al botón aceptar
	 * En el se recogen los parámetros del los textView 
	 * Se comprueba que la contraseña introducida y la que tiene el usuario sean iguales
	 * */
...
//		hilo.start();
	...
	/**
	 * Método que comprueba que la contraseña nueva no sea vacia
	 * y que la contraseña nueva coincidan las dos la nueva ya repetir contraseña nueva
	 * */
